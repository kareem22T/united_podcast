        ...
        <div>
            ...
            <div class="w-100 mb-4">
                <div class="form-group">
                    <label for="brief" class="form-label">نبذة عن الناشر *</label>
                    <textarea type="text" class="form-control" id="brief" v-model="brief">
                    </textarea>
                </div>
            </div>
    ...
    async add() {
      $('.loader').fadeIn().css('display', 'flex')
        try {
            ...
            setTimeout(() => {
                $('#errors').fadeOut('slow')
                window.location.href = '{{ route("author.prev") }}'
            }, 2000);
            } else {
            $('.loader').fadeOut()
            document.getElementById('errors').innerHTML = ''
