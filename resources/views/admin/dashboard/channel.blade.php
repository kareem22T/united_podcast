...
@section('title', 'عؤض مقالات البرنامج')
...
<div class="card w-100" id="word_prev">
    <div class="card-header d-flex justify-content-between gap-3">
        <h3>مقالات {{$channel->title}}</h3>
        <a href="{{route('channels.edit', ['id' => $channel->id])}}" class="btn btn-primary w-fit d-flex gap-2 align-items-center">
            <i class="ti ti-edit"></i> تعديل البرنامج
        </a>
    </div>
...
createApp({
    data() {
        return {
            ...
            article_name: null,
            delete_pop_up: false,
            articles_data: @json($channel->articles),
            search: null,
            page: 1,
            total: null,
            last_page: null
