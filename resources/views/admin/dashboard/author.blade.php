...
@section('title', 'عرض بيانات الناشر')
...
<div class="card w-100" id="word_prev">
    <div class="card-header d-flex justify-content-between gap-3">
        <h3>مقالات {{$author->name}}</h3>
        <a href="{{route('channels.edit', ['id' => $author->id])}}" class="btn btn-primary w-fit d-flex gap-2 align-items-center">
            <i class="ti ti-edit"></i> تعديل بيانات الناشر
        </a>
    </div>
...
createApp({
    data() {
        return {
            ...
            article_name: null,
            delete_pop_up: false,
            articles_data: @json($author->articles),
            search: null,
            page: 1,
            total: null,
            last_page: null
