...
style="color: #030386;line-height: 22px;"
    ...
    <div class="links" style="margin-top: 1rem; display: flex; justify-content: center; align-items: center; gap: 10px; flex-direction: row-reverse">
        ...
        @endif
        @if($contact->anghami)
        <a target="_blank" href="{{$contact->anghami}}" style="grid-column: span 2" class="anghami">
    ...
    @endif
        ...
        @endif
        @if($contact->spotify)
            <a target="_blank" href="{{$contact->spotify}}" style="grid-column: span 2">
...
<div class="hide-content contact_hide_contact"></div>
<div class="contact-pop-up">
    ...
    <div style="display: flex;flex-direction: column;justify-content: center;align-items: center;gap: 0;margin: 10px 3rem;">
        ...
        <h4 style="font-weight: 700;">ارسل لنا رسالة</h4>
