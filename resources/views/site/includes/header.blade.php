...
<div class="login-pop-up">
    ...
    <div style="display: flex;flex-direction: column;justify-content: center;align-items: center;gap: 0;margin: 10px 3rem;">
        <img alt="ثمانية" loading="lazy" decoding="async" data-nimg="1" class="!w-auto" style="color:transparent;vertical-align:middle;width:auto;margin-bottom: 30px;width: 160px !important;object-fit: contain;height: 100px !important;" src="{{ asset("assets/img/logo-trans.png") }}" width="90" height="50">
